...
public class SampleStringProcessor implements MessageProcessor {
	...
	private HedgehogRobotArm hhra;

	public SampleStringProcessor(HedgehogRobotArm hhra) {
		this.hhra = hhra;
	}


	/**
	 * @see at.pria.osiris.linker.communication.messageProcessors.MessageProcessor#processMessage(Object)
	 */
